(function () {
    ...
    // TODO: Make user defined callbacks on insert / edit and so on possible
    // @see https://github.com/matteodem/meteor-crud-generator/wiki/New-possiblf  ye-features
    ...
    CRUDMarkupGenerator = function (options) {
        ...
        if (!_.isUndefined(options.styling) && Meteor.isClient) {
    ...
    CRUDGenerator = function (collection, schema, options) {
        ...
        if (Meteor.isClient) {
            ...
            // Define meteor specific template
