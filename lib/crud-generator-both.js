(function () {
    ...
    TypeFactory = function (additionalTypes) {
        // TODO: Implement foreach through additionalTypes and add
    }
    ...
    CRUDGenerator.prototype = {
        ...
        getFormValues : function (tableRow, schema) {
            ...
            _.each(schema, function (value, key) {
                var fieldDef = that.recognizeFieldDefinition(value);

                returnObj[key] = that.typeFactory
        ...
        valueIsValid : function (schemaDef, value) {
            ...
            this.typeFactory
                ...
                .checkType(value, definitionObj.contentType);
